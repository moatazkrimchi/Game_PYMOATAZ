...
class MapManager:
    ...
    def __init__(self, screen, player):
        ...
        self.register_map("world", portals=[
            ...
            NPC("paul", nb_points=4, dialog=["Bonjour je cherche samouha ", "va chez ROBIN", "merci beaucoup"] ),
            NPC("robin", nb_points=2, dialog=["Bonjour ROBIN ", "Bonjour Moataz, tu cherche quoi ", "j'ai pas trouvé samouha, aide moi !!", "samouha est dans le dangon, bonne aventure "])


        ])
        self.register_map("house", portals=[
            Portal(from_world="house", origin_point="enter_house", target_world="world", teleport_point="enter_house_ex")
        ])
        ...
        self.register_map("dungeon", portals=[
            ...
            NPC("boss", nb_points=2, dialog=["Samouha c'est toi ? ", "Biensur c'est la matinée, je deviens un monstre  ", "MALHEUREUSEMENT, Mais je t'aime beaucoup <3 ", "Moi aussi mon Prince  "])
        ])

        self.teleport_player("play")
        self.teleport_npcs()
